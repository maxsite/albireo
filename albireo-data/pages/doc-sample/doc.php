...
<div class="pad30-rl mar30-tb">
    ...
    _ Работает _Albireo Doc_ работает точно также, как и любые другие страницы Albireо. Разница только в том, что в _Albireo Doc_ использует особый layout-шаблон вывода.
